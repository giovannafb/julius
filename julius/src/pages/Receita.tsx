            ...
            <Dialog open={openModal} onClose={fecharModal} fullWidth maxWidth="xs" PaperProps={{ sx: { borderRadius: 4 } }}>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <DialogContent sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                        <TextField label="Descrição" placeholder="Ex: Salário" slotProps={{ inputLabel: { shrink: true } }} {...register("descricao")} error={!!errors.descricao} helperText={errors.descricao?.message} />
                        ...
                        <TextField label="Fonte" placeholder="Ex: Empresa X" slotProps={{ inputLabel: { shrink: true } }} {...register("fonte")} error={!!errors.fonte} helperText={errors.fonte?.message} />
                    </DialogContent>
